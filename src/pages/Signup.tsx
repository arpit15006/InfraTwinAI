            ...
            <div className="hidden lg:flex flex-1 bg-primary flex-col justify-between p-10 text-primary-foreground">
                ...
                <div className="space-y-6 max-w-lg">
                    <h1 className="text-4xl font-extrabold leading-tight">
                        Join the Future of{' '}
                        <span className="text-emerald-300">Infrastructure.</span>
                    </h1>
                    <p className="text-white/70 text-base leading-relaxed">
                        Create your account to start monitoring, predicting, and optimizing
                        infrastructure health with AI-powered digital twins.
                    </p>
                        ...
                        <CardContent>
                            <form onSubmit={handleSignup} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="email" type="email" placeholder="arjun@infratwin.ai" required />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="org">Organization</Label>
                                    <Input id="org" placeholder="NHAI / Metro Corp / etc." required />
                                </div>
                                <div className="space-y-2">
                                    <Label>Role</Label>
